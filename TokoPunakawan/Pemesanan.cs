...
namespace TokoPunakawan
{
    public partial class Pemesanan : Form
    {
        ...
        {
            SqlConnection conn = new SqlConnection("Data Source=NOP\\MSSQLSERVER01;Initial Catalog=Toko_Punakawan1;User ID=sa;Password=kontoru555");
        ...
        private void Pemesanan_Load(object sender, EventArgs e)
        {
            ...
            this.pemesanananTableAdapter.Fill(this.toko_Punakawan1DataSet.Pemesananan);
